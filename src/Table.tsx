...
export function Table({ initialView, splitView, fullView }: IProps) {
  const [width, setWidth] = useState<TableContainerWidths>(TableContainerWidths.initial);
  ...
  return (
    <div style={{display: 'flex', alignItems: 'baseline', justifyContent: 'center', border: "1px solid black", width }}>
